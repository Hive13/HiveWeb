...
UPDATE storage_slot SET type_id = 'ecfcdf63-c04e-4034-814a-b43541b3ac76' WHERE name LIKE 'V-%';
UPDATE storage_slot SET type_id = '1fc943ed-fe6e-4a01-8798-da3dc814fa22' WHERE name LIKE 'H-%';
